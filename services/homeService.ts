...
//  // ── NEW: Fetch Hotel Invoice PDF for a specific booking ───────────────────
//   getHotelInvoice: async (bookingId: number) => {
//     try {
//       const { data } = await api.get(`/hotel_invoice/get_daily_booking_details_for_dashbord`, {
//         params: {
